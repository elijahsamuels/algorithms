...
//   "Alphonse Francis Capone",
// ]
// // function nameCheckrExactMatch(knownNames, name) {
...
// // nameCheckrExactMatch(knownNames, "Alphonse Gabriel Capone"); // true




// // function nameCheckrMiddleNameUknown(knownAliases, name) {

// //   // split the name into an array of words
// //   // if the two names are included in one of the items in the alias array, return that index

// //   let nameArray = name.split(" ");
// //   // console.log(nameArray[nameArray.length - 1])
// //   knownAliases.map(alias => { 
// //     if (alias.includes(nameArray[0]) && alias.includes(nameArray[nameArray.length - 1])) {
// //       console.log(alias);
// //       return alias;
// //     } else {
// //       // console.log(alias)
...
// // nameCheckrMiddleNameUknown(knownNames, "Alphonse Capone"); // 

// // function nameCheckrMiddleNameUnkownOnRecord(namesOnRecord, aliasName) {
// //   // split the name into an array of words
// //   // if the two names are included in one of the items in the alias array, return that index

// //   let aliasNameArray = aliasName.split(" ");

// //   namesOnRecord.map(name => { 
// //     if (name.includes(aliasNameArray[0]) && name.includes(aliasNameArray[aliasNameArray.length - 1])) {
// //       console.log(name);
// //       return name;
// //     } else {
// //       // console.log(alias)
...
// //   })
// // }
// // nameCheckrMiddleNameUnkownOnRecord(knownNames, "Alphonse Capone")

// function checkAnyMiddleName(knownAliases, namesOnRecord) {

//   // split the name into an array of words
//   // if both first and last name are included, then check for middle name

//   let nameToFindArray = knownAliases.split(" ");

//   for (let i = 0; i < nameToFindArray.length; i++) {



//     if (namesOnRecord.includes(nameToFindArray[i])){
//       console.log(nameToFindArray[i])
//       return namesOnRecord[i];
//     } else {
//       return false
//     }
//   }
...
// checkAnyMiddleName(knownAliases, namesOnRecord)
